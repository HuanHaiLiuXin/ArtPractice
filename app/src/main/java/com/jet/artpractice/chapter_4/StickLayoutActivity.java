...
public class StickLayoutActivity extends BaseActivity implements
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        Toast.makeText(StickLayoutActivity.this,childList.get(groupPosition).get(childPosition).getName(), Toast.LENGTH_SHORT).show();
        return false;
    }
    ...
    public View getPinnedHeader() {
        View headerView = (ViewGroup) getLayoutInflater().inflate(R.layout.c4_group, null);
    ...
    class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.c4_group, null);
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.c4_child, null);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(StickLayoutActivity.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
